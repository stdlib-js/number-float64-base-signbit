...
```javascript
signbit = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-signbit@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-signbit@v0.2.3-umd/browser.js"></script>
```
